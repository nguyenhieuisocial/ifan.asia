...
**QUAN TRỌNG — trước khi dựng bất kỳ bảng/migration mới:** đọc Phần IV mục 23–24 của Quy hoạch (định nghĩa "đầy đủ" + HỢP ĐỒNG DỮ LIỆU chốt một lần cho catalog/variants, lịch hẹn+cọc, đơn hàng+hoàn, kho stock_moves, voucher, gói buổi, hoa hồng, thu chi, sub_profiles, lead_submissions) — thực thể nào có hợp đồng thì dựng ĐÚNG hợp đồng, cấm tự chế; mục 26 (module × ngành) + 27 (ma trận quyền chuẩn) là khuôn bắt buộc.
