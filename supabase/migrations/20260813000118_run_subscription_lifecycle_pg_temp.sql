-- Vá nốt 1 hàm security definer lọt lưới task #38 (87 hàm ghim pg_temp cuối
-- search_path, migration cũ) — bắt được bằng chính rls-smoke.mjs (check tĩnh
-- "Mọi hàm security definer đã ghim pg_temp cuối search_path"), không phải
-- soát tay. Hàm được viết lại (migration #94, 20260813000089_trial_reminder_
-- 7_2_days.sql) SAU đợt vá #38 nên không được thừa hưởng — giữ NGUYÊN thân
-- hàm, chỉ thêm 'pg_temp'.
