...
| 0029 | **Bản đồ 17 vùng là bản đồ LÃNH THỔ, không phải bản đồ PHẠM VI** | 22/08 — chốt rằng cụm *"bản đồ năng lực đang có hiệu lực"* trong **ADR-0011** vẫn là ADR-0012 / `feature-registry.ts`, **không** phải bản đồ nghiệp vụ 17 vùng / 164 domain mới. Nếu không chốt, điều kiện mở bán **tự lùi từ "đã đủ" về "còn ~133 domain"** mà không ai quyết và không gì báo. Bài học: một điều kiện trỏ tới *"tài liệu X đang có hiệu lực"* **phải ghi rõ X là file nào** |
