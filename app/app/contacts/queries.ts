...
const CONTACTS_SELECT = `id, full_name, phone, email, tier, owner_id, created_at, updated_at,
  lead_sources(name),
...
export async function fetchContactDetail(
  ...
  const { data, error } = await supabase
    .from("contacts")
    .select(
      `id, full_name, phone, email, tier, owner_id, source_id, company_id, created_at, updated_at,
