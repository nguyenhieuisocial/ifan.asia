...
> {
  ...
  // removeMember chỉ đổi cờ chứ KHÔNG xoá dòng) vẫn tạo/sửa/xoá được mã QR và nguồn khách
  ...
  if (!member || !MANAGE_ROLES.includes(member.role) || !tenant) return { error: "forbidden" };
